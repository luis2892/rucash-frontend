...
function App() {
  const { isAuthenticated, isAdminSistema, accessToken } = useAuthStore();

  // Ruta protegida normal — requiere login
  ...
  // Ruta solo para SUPER ADMIN (Luis)
  ...
  return (
    <Router>
      <Routes>
        ...
        {/* Solo SUPER ADMIN — Luis Félix */}
        <Route path="/admin/suscripciones" element={<AdminRoute element={<AdminSuscripcionesPage />} />} />
        <Route path="/admin/configuracion" element={<AdminRoute element={<AdminConfigPage />} />} />
